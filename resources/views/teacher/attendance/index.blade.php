        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('subjects.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('subjects.classes', $subject->id) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">{{ $subject->code }}</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('assessments.index', [$subject->id, $classSection->id, $term, $assessment->assessmentType->id]) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">{{ $classSection->section }}</a>
                    </div>
                </li>
